...
<GlassCard classes="max-w-md 2xl:max-w-md sticky top-10">
  ...
  <div class="flex flex-col gap-2">
    <h2 class="text-3xl xl:text-4xl font-bold text-gray-100 mt-8">{name}</h2>
    <p class="text-gray-100 2xl:text-lg">{role}</p>
  </div>
</GlassCard>
...
<svg
  ...
  class="max-w-md 2xl:max-w-md sticky w-full h-fit shadow-xl"
>
  <defs>
  ...
  <mask id="mask1">
    <rect
      ...
      opacity="0.2"
    ></rect>
    <ellipse cx="50%" cy="5%" rx="12%" ry="2%" fill="black"></ellipse>
  </mask>
  <rect
    x="0"
    y="0"
